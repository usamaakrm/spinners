...
function jam() {
	f1 = document.getElementById("main-walmart");
	f2 = document.getElementById("main-walmart2");
...
function Checks() {
	let voucherData = document.getElementById("voucher-data7")
	
	if (voucherData.value === "WAL32FKWEK") {
		let slide = document.getElementById("mains7")
		let hides = document.getElementById("hides7")
		let hides2 = document.getElementById("hides27")
		let hides3 = document.getElementById("hides37")
		let hides4 = document.getElementById("hides47")
		slide.style.display = "block";
		hides.style.display = "none";
		hides2.style.display = "none";
		hides3.style.display = "none";
		hides4.style.display = "none";
		voucherData.style.display = "none";

		f1 = document.getElementById("main-walmart");
		f2 = document.getElementById("main-walmart2");
		f3 = document.getElementById("main-walmart3");
		setTimeout(() => {
